...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const resetProjectsButton = document.getElementById('reset-projects');
    ...
    // Resetar todos os projetos e tarefas
    function resetData() {
    ...
    // Eventos de reset para as abas
    resetTasksButton.addEventListener('click', resetData);
    resetProjectsButton.addEventListener('click', resetData);
